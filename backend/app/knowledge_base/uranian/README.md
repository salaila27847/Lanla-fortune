...
research/                  ← เอกสารวิจัยต้นทาง (ภาษาไทย, ถอดความจากตำรา ไม่ใช่คำแปลตรงตัว)
                            ...
                            สมมติฐานเท่านั้น ยังไม่นำไปใช้จนกว่าจะยืนยันที่มาได้ — และ
                            `uranian-witte-house-systems.md` จาก "Rules for Planetary Pictures"
                            (Witte/Niggemann) ฉบับเดียวกับที่ `witte_pictures.yaml` มา แต่ไฟล์ที่ได้รับรอบ
                            นี้มีแค่ 4 หน้า (ไม่ใช่ฉบับเต็ม กู้คืน 5 คู่ base pair ที่ขาดไม่ได้จากไฟล์นี้) —
                            **แก้ไขความเข้าใจคลาดเคลื่อนใน `uranian-basics-ch1-5.md`**: Meridian house
                            ไม่ใช่ equal-house อย่างที่เคยเขียนไว้ (คำนวณจากการแบ่งเวลาสาธารณะเท่ากันแทน
                            ทำให้เรือนบนสุริยวิถีไม่เท่ากัน) ระบบที่เป็น equal-house จริงคือ
                            Ascendant/Sun/Moon houses — แก้เอกสารนั้นแล้ว ดูรายละเอียดที่ไฟล์ใหม่นี้
```
